...
public class GenericSparkFlexMotor extends SubsystemBase {
  private final SparkFlex m_motor;
  private final SparkClosedLoopController m_clController;
  private final RelativeEncoder m_encoder;

  public GenericSparkFlexMotor(int canId, MotorType motorType, SparkBaseConfig config) {
    m_motor = new SparkFlex(canId, motorType);
